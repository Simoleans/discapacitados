...
$a="";
	if(isset($_GET['error'])){
		$a="<p style='color:red;'>No se encontraron resultados</p>";
	}
?>
...
<html>
	...
	<hgroup><h3 align="center">Buscar usuario</h3></hgroup>
	
	<?php echo $a; ?>
	<p><?php echo "Esta conectado como: ".$_SESSION['user']; ?></p>
	<br>
	<br>
	<section>
	<table class="table" id="Tabla_per2" align="center">
		<form action="Modulo/busqueda.php" method="get">
		<tr>
			<td><label>Inserte Cedula</label>
				<input class="ola si"  pattern="[0-9]{6,8}" required="required" type="text" name="cedula" placeholder="12345678" autofocus>
			</td>
			<td><br>
